...
<details open>
  ...
  <ul>
    ...
    <li><a href="#-sơ-đồ-luồng-hoạt-động-sequence-diagram">Sơ Đồ Luồng Hoạt Động (Sequence Diagram)</a></li>
    <li><a href="#-công-nghệ-sử-dụng">Công Nghệ Sử Dụng</a></li>
    <li><a href="#-hướng-dẫn-khởi-chạy-docker">Hướng Dẫn Khởi Chạy (Docker)</a></li>
    <li><a href="#-tài-khoản-demo">Tài Khoản Demo</a></li>
    <li><a href="#-giải-thích-chi-tiết-code-deep-dive">Giải Thích Chi Tiết Code (Deep Dive)</a></li>
  </ul>
</details>
...
> 
> 1️⃣ **SignalR chỉ là "Trợ lý Bắt tay" (Signaling Server):** Nhiệm vụ duy nhất của Backend là luân chuyển các gói tin siêu nhẹ gồm SDP Offer, SDP Answer, ICE Candidates và trạng thái Online/Offline.
> 
> 2️⃣ **TUYỆT ĐỐI KHÔNG TRUYỀN VIDEO QUA SERVER:** Toàn bộ luồng hình ảnh/video được truyền **trực tiếp giữa 2 trình duyệt** thông qua `RTCPeerConnection` của WebRTC. Nhờ đó, Backend server hoàn toàn không chịu tải video, giúp hệ thống scale dễ dàng.
...
| 🟣 Backend | 🟢 Frontend | 🐳 Hạ Tầng (DevOps) |
| :---: | :---: | :---: |
| <img src="https://skillicons.dev/icons?i=dotnet,cs,sqlite" /> | <img src="https://skillicons.dev/icons?i=vue,ts,tailwind,vite" /> | <img src="https://skillicons.dev/icons?i=docker,nginx,linux" /> |
| **ASP.NET Core 10 Web API** | **Vue 3 (Composition API)** | **Docker & Docker Compose** |
| SignalR Hub | TypeScript & Pinia | Nginx Web Server |
| Entity Framework Core 10 | Tailwind CSS v3 | Coturn (STUN/TURN Server) |
| JWT Authentication | Native WebRTC API | |
